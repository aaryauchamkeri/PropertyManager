...
export default function Properties() {
    ...
    async function deleteProperty(propertyId, index) {
        ...
        let res = await fetch(`https://propertymanager.onrender.com0/properties/delete/${propertyId}`, {
            method: 'POST',
            headers: {
                'Authorization': `Bearer ${infoContext.userData.auth}`,
                'accountId': infoContext.accountId
    ...
    async function updatePropertyStatus(value, propertyId) {
        try {
            let res = await fetch(`https://propertymanager.onrender.com0/properties/update`, {
                method: 'POST',
                headers: {
                    'Authorization': `Bearer ${infoContext.userData.auth}`,
                    accountId: infoContext.accountId,

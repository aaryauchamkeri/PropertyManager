...
config({ path: '../../.env' });
const authSecret = "92a795190818bfdb7013a0c1ec506092c6fdd89f6a8854272c3f933ecb22f10183d4b52889f260e9c07061939b79e81ff8c7bf86da3e5f9e64da9787c22304c2";
...
let authorizeToken = (req, res, next) => {
    if (req.headers.authorization) {
        jwt.verify(req.headers.authorization.split(' ')[1], authSecret, (err, decodedToken) => {
            if (err) {
                res.status(401).json({
                    "err": "expired token",
                    "status": 401
